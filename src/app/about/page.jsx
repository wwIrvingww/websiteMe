    ...
    <div className={styles.container_about}>
      ...
      <div className={styles.limage_container}>
        <div className={styles.limage_about}>
          <img src={'https://i.pinimg.com/736x/6f/58/87/6f58875204d87f535eb17badd7bed1a8.jpg'} alt={'image left'}/>
        </div>
      ...
      <div className={styles.rimage_container}>
        <div className={styles.rimage_about}>
          <img src={'https://i.pinimg.com/736x/b7/c3/0a/b7c30a6a3d32ac6e4c38791b20780822.jpg'} alt={'image right'}/>
        </div>
